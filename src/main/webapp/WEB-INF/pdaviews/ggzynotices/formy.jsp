...
<c:if test="${empty ggzyBidPro}">
	<c:set var="ggzyBidPro" value="${ggzyNotice.bidPro }" />
	   ...
	   <c:set var="backUrl" value=" /ggzy/business/ggzynotices?nv_=ggzynotices/audit_list&search_EQ_noticeMaked=1&orderField=makeTime&businessTypeId=F785D42A3F81B399E040007F0100159F&taskId=auditnotice_js&taskId=auditnotice"/>
	    <div class="twotit">

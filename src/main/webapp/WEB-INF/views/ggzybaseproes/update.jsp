...
<form method="put" action="${contextPath }/${business_ctx}/ggzybaseproes/update" class="required-validate pageForm" onsubmit="return validateCallback(this, dialogReloadNavTab);">

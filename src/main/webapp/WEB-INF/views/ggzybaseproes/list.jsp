...
<dwz:paginationForm
	action="${contextPath }/${business_ctx}/ggzybaseproes" page="${page }"
		...
		<ul class="toolBar">
			<shiro:hasPermission name="User:save">
				<li><a iconClass="application_form_magnify" target="dialog"
					...
					href="${contextPath }/${business_ctx}/ggzybaseproes/{slt_uid}"><span><spring:message code="ggzybasepro_showbtn"/> </span></a></li>
			</shiro:hasPermission>
			<shiro:hasPermission name="User:save">
				<li><a iconClass="application_add" target="dialog"
					rel="lookup2organization_add" mask="true" width="800" height="330"
					href="${contextPath }/${business_ctx}/ggzybaseproes?business_type=F785D42A3F81B399E040007F0100159F&form"><span><spring:message code="ggzybasepro_addbtn"/> </span></a></li>
			</shiro:hasPermission>
			<shiro:hasPermission name="User:edit:User拥有的资源">
				<li><a iconClass="application_edit" target="dialog"
					...
					href="${contextPath }/${business_ctx}/ggzybaseproes/{slt_uid}?form"><span><spring:message code="ggzybasepro_updatebtn"/></span></a></li>
			</shiro:hasPermission>
			<shiro:hasPermission name="User:delete:User拥有的资源">
				<li><a iconClass="application_delete" target="selectedTodo" rel="ids"
					href="${contextPath }/${business_ctx}/ggzybaseproes/delete"
	...
	<table class="table" layoutH="137" width="100%">
		...
		<tbody>
			<c:forEach var="item" items="${list}">
				<tr target="slt_uid" rel="${item.baseProId}">
					<td><input name="ids" value="${item.baseProId}" type="checkbox"></td>
					<td>${item.proCode}</td>
					<td>${item.proName}</td>

...
<form method="post" action="${contextPath }/${business_ctx}/ggzybaseproes/create" class="required-validate pageForm" onsubmit="return validateCallback(this, dialogReloadNavTab);">

...
<!--
	function validAudit() {
		try {
			var data = $.parseJSON($('#selectDataauditnoticetable', navTab.getCurrentPanel()).val());
...
<div class="pageContent">
	...
	<div class="panelBar">
		<ul class="toolBar">
			<li><a iconClass="application_form_magnify" target="dialog" rel="notice_audit_show" mask="true" width="1000" height="600" href="${contextPath }/${business_ctx}/${module_path}/{slt_uid}" name="ggzynotice_showbtn"><span><spring:message code="ggzynotice_showbtn" /> </span></a></li>

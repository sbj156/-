...
<div class="pageFormContent" layoutH="58">
	...
	<div class="div_xmtj">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tble_xmlb">
			...
			<tr>
				<td class="td1"><label>挂牌开始时间：</label></td>
				<td class="td2"><input type="text" id="tendererDocGainTime" name="tendererDocGainTime" class="date validate[required] required" value='<spring:eval expression="ggzyNotice?.tendererDocGainTime"/>' onfocus="WdatePicker({dateFmt:'yyyy-MM-dd 09:00:00'})" readonly="readonly" /></td>
				<td class="td1"><label>挂牌结束时间：</label></td>
				<td class="td2"><input type="text" name="tendererDocGainEndTime" id="tendererDocGainEndTime" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd 17:00:00'})" class="date validate[required] required" value='<spring:eval expression="ggzyNotice?.tendererDocGainEndTime"/>' readonly="readonly" /></td>
			</tr>
			<tr>
				<td class="td1"><label>现场交易时间：</label></td>

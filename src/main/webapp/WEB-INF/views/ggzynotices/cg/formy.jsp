...
<div class="pageFormContent" layoutH="58">
	...
	<input type="hidden" name="noticeType.id" value="21725" />
	<div class="div_xmtj">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tble_xmlb">
			<caption>
				<%--表单名称 --%>
				${businessType.name }<spring:message code="ggzybidinvitation"/>
			</caption>
			<tr>
				...
				<td class="td1"><label><spring:message code="ggzybasepro_proname"/>：</label></td>
			...
			<tr>
				...
				<mh:dataClob name="tendererDocGainWay" dataClob="${ggzyNotice.tendererDocGainWay}"></mh:dataClob></td>
			</tr>
			<!--  <tr>

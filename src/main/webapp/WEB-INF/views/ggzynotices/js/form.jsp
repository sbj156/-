	...
	<div class="div_xmtj">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tble_xmlb">
			...
			<tr>
				...
				<td class="td2"><input type="text" name="bidDocSubEndtime" class="date validate[required,ajax[ajaxBidSite]] required" value='<spring:eval expression="ggzyNotice?.bidDocSubEndtime"/>' onfocus="WdatePicker({dateFmt:'yyyy-MM-dd 09:30:00', minDate:'#F{$dp.$D(\'tendererDocGainEndTime\',{d:20, H:-%H-1})||\'%y-%M-{%d+20} 09:30:00\'}'})" readonly="readonly" /></td> --%>

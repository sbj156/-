			...
			<tr>
				...
				<td class="td2" colspan="3"><span style="float: left; line-height: 20px"> <c:choose>
							<c:when test="${empty ggzyBidPro.fileList }">
								<input name="fileList" type="checkbox" id="FILE_LIST" value="建设项目计划批文及附件（济南市建设项目招标方案核准意见）"> A、建设项目计划批文及附件（济南市建设项目招标方案核准意见）； <br>
								<input name="fileList" type="checkbox" id="FILE_LIST" value="建设工程规划许可证"> B、建设工程规划许可证； <br>
								<input name="fileList" type="checkbox" id="FILE_LIST" value="初步设计概算批准文件（国有投资项目）"> C、初步设计概算批准文件（国有投资项目）； <br>
								<input name="fileList" type="checkbox" id="FILE_LIST" value="建设工程施工图设计文件审查备案书"> D、建设工程施工图设计文件审查备案书； <br>
								<input name="fileList" type="checkbox" id="FILE_LIST" value="经市建设主管部门备案的《招标代理合同》"> E、经市建设主管部门备案的《招标代理合同》。
					</c:when>
							<c:otherwise>

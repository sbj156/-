...
<form id="permissionForm" method="post" action="${contextPath }/management/security/module/create" class="required-validate pageForm" onsubmit="">
	...
	<div id="permissionFormContent" class="pageFormContent" layoutH="58">
		...
		<p>
			<label>是否是业务模块：</label>
			<input type="radio" value="0" name="businessModule"/>否
			<input type="radio" value="1" name="businessModule"/>是
		</p>			
		<p class="nowrap">
			<label>链接参数：</label>
			<textarea name="parameters" cols="29" rows="3" maxlength="256" class="input-medium textarea-scroll"></textarea>
		</p>
		<p>
			<label>是否是JSON参数：</label>
			<input type="radio" value="0" name="jsonParam"/>否
			<input type="radio" value="1" name="jsonParam"/>是
		</p>		
		<p>

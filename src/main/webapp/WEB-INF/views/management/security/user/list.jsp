...
<div class="pageContent">
	...
	<div class="panelBar">
		<ul class="toolBar">
			...
			<shiro:hasPermission name="User:assign">				
				<li class="line">line</li>
				<li><a iconClass="group_link" target="dialog" mask="true" width="800" height="500" href="${contextPath }/${business_ctx }/ggzybiddingusers/{slt_uid}?form" rel="assign_subject" data='{"nv_":"management/security/user/assign_subject"}'><span>关联招投标主体</span></a></li>
			</shiro:hasPermission>
		</ul>
	</div>

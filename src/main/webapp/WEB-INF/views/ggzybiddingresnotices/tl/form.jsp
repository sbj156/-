							...
							<tr>
								<td colspan="2">
									<table style="font-size: 12px" border=0 width="100%" height=480>
										...
										<tr>
											<td style="font-size: 20px" colspan=2 align=center><b>中&nbsp;标&nbsp;通&nbsp;知&nbsp;书</b><br> <span style="font-size: 14px">(铁路工程类)</span></td>
										</tr>
										<tr>
							...
							<tr>
								<td style="font-size: 12px" colspan=4>
									<table style="font-size: 12px" border=0 width="100%" height=480>
										<tbody>
											<tr>
												<td style="line-height: 6mm" id=notice height=61 valign=bottom colspan=2><%-- ${tenders.fee.noticeTenders.biddingCandidate.applyTender.apply.biddingSubject.subjectName } --%>${noticeTenders.biddingCandidate.applyTender.apply.biddingSubject.subjectName}：<br>&nbsp;&nbsp;&nbsp;&nbsp;${tenders.proName }<%--工程名称 --%>，于<spring:eval expression="tenders.fee.noticeTenders.bidTime" /> 在济南公共资源交易中心开标后，经评标委员会评审，招标人确定，招标监督机构核准，你单位被确定为中标人。<br>&nbsp;&nbsp;&nbsp;&nbsp;<font style="font-family: 黑体">中标项目地点：</font>${tenders.bidPro.basePro.proAddress }<br>&nbsp;&nbsp;&nbsp;&nbsp;<font style="font-family: 黑体">中标项目概况(规模)：</font>${tenders.area }平方米&nbsp;&nbsp;&nbsp;&nbsp;结构类型：${tenders.structureType }<br>&nbsp;&nbsp;&nbsp;&nbsp;<font style="font-family: 黑体">招标范围：</font>${tenders.bidRange }
												<br>&nbsp;&nbsp;&nbsp;&nbsp;<font style="font-family: 黑体">中标价(人民币)：</font>${noticeTenders.biddingCandidate.applyTender.ggzyBidDocs.price }元&nbsp;&nbsp;&nbsp;<font style="font-family: 黑体">中标工期:</font>${noticeTenders.biddingCandidate.applyTender.ggzyBidDocs.projectDuration }日历天<br>&nbsp;&nbsp;&nbsp;&nbsp;<font
													style="font-family: 黑体">质量要求：</font>${noticeTenders.biddingCandidate.applyTender.ggzyBidDocs.quality}<%-- ${tenders.fee.noticeTenders.biddingCandidate.applyTender.ggzyBidDocs.quality } --%>&nbsp;&nbsp;&nbsp;&nbsp;<font style="font-family: 黑体">项目负责人(项目经理)：</font>许庙康。<br> <font style="font-family: 黑体">其他内容：</font> <span>
														<div id=text></div>
												</span></td>
											</tr>
											<tr>

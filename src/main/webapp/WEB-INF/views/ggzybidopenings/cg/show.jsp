...
jQuery(document).ready(function(){
	$('#mainPanel').loadUrl("${contextPath }/${business_ctx}/${module_path}?form&tendersId=${param.tendersId}&nv_=ggzybidopenings/${noticeTenders.ggzyBidOpenings.openningType.formView}&businessTypeId=${param.businessTypeId }",{},function(){
...
<form method="post" action="${contextPath }/${business_ctx}/${module_path}" class="required-validate pageForm" onsubmit="return validateCallback(this, ${empty subCallbackFun?'dialogReloadNavTab':subCallbackFun});">
	...
	<div class="pageContent">
		...
		<div class="formBar">
			<ul>
				<li><div class="button">
						<a class="icon" href="${contextPath }/${business_ctx}/${module_path}/exportExcel/<spring:eval expression="noticeTenders.id"/>?businessTypeId=${param.businessTypeId}" target="dwzExport" targetType="dialog"> <span>导出EXCEL</span>
						</a>
					</div></li>
				<li><div class="button">

...
jQuery(document).ready(function(){
	$('#mainPanel').loadUrl("${contextPath }/${business_ctx}/${module_path}?form&tendersId=${param.tendersId}&nv_=ggzybidopenings/${noticeTenders.ggzyBidOpenings.openningType.formView}",{

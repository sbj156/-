	...
	<div class="panelBar">
		<ul class="toolBar">
			...
			<shiro:hasPermission name="bidopening:annulled">
				<li><a iconClass="application_add" target="dialog" rel="bidopening_annulled" mask="true" width="900" height="600" href="${contextPath }/${business_ctx}/ggzyexceptionalcases?form&tendersId={slt_uid}" click="{fun:validAnnull}"><span><spring:message code="ggzybidopening_annulledbtn" /> </span></a></li>
			</shiro:hasPermission>

			<li><a iconClass="application_add" target="dialog"
					rel="evaluation_score_type" mask="true" width="500" height="600"
					href="${contextPath }/${business_ctx}/ggzynoticetenderses/{slt_uid}?form&scoreTypeParentId=21"  data='{"nv_":"ggzyevaluationreports/assign_score_type"}'><span><spring:message code="ggzyevaluationreport_assignscoretypebtn_type"/> </span></a></li>

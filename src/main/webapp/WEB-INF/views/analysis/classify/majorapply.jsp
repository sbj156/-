...
<c:set value="${contextPath }/${business_ctx}/analysis/classify/majorapply" var="listUrl_" />
...
<div class="pageContent " selector="h1" layoutH="42">
	<div class="pageFormContent" layoutH="58">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tble_xmlb">
			<tr>
				<td class="td1" rowspan="2">专业类型</td>
				<td class="td1" rowspan="2"><label>交易金额(元)</label></td>
				<td class="td1" rowspan="2"><label>标段数</label></td>
				<td class="td1" rowspan="2"><label>报名企业数</label></td>
				<td class="td1" rowspan="2"><label>投标企业数</label></td>
				<td class="td1" style="text-align: center" colspan="${businessType.ggzyBusinessTypeWays.size() }">交易方式</td>
			</tr>  
			<tr>
			...
			<c:forEach items="${data}" var="item" varStatus="status">
				<tr>
					...
					<td class="td2">${item.atotal}</td>
					<td class="td2">${item.attotal}</td>

...
<form method="post" action="${contextPath }/<spring:message code="busienss_ctx"/>/ggzyattachments/create" class="required-validate pageForm" onsubmit="return validateCallback(this, dialogReloadNavTab);">
	<c:choose>
	...
	<p>
		<label><spring:message code="label_com_lmd_ggzy_domain_ggzyattachment_attachmentname" /></label>
		<input type="text" name="attachmentName" maxlength="64" class="input-medium required validate[required]"/>
	</p>	
	<%-- <p>
		<label><spring:message code="label_com_lmd_ggzy_domain_ggzyattachment_attachmentname" /></label>

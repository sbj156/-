...
<!--
	...
	jQuery(document).ready(function() {
		...
		$(".cancleLink").click(function (){
			
			var id = $(this).attr("id").split("submit_")[1];
			jQuery.ajax({
				type : 'POST',
				dataType : "json",
				contentType : "application/json",
				url : '${contextPath}/business/ggzytendersscoretypes/delete/' + id,
				error : function() {
					alertMsg.error('取消统一打分类型失败！');
				},
	...
	<fieldset>
		...
		<table class="list" width="100%">
			<thead>
				<tr>
					<th width="40%">类型名称</th>
					<th width="30%">排序优先级（数值越小，优先级越高）</th>
					<th width="30%">操作</th>
				</tr>
			</thead>
			<tbody id="hasRoles">

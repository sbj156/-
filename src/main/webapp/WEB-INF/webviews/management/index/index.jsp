...
<title>济南公共资源综合管理系统</title>
<link href="${contextPath}/styles/dwz/themes/default/style.css" rel="stylesheet" type="text/css" media="screen"/>
<link href="${contextPath}/styles/main.css" rel="stylesheet" rel="stylesheet" type="text/css" media="screen"/>
...
<link href="${contextPath}/styles/supervice.css" rel="stylesheet" type="text/css" />
...
<script src="${contextPath}/styles/jquery/jquery.extends.js" type="text/javascript"></script>
<script src="${contextPath}/styles/jquery/jquery.base64.js" type="text/javascript"></script>
<script src="${contextPath}/styles/dwz/js/jquery.bgiframe.js" type="text/javascript"></script>
<script src="${contextPath}/styles/dwz/js/buttonValid.js" type="text/javascript"></script>
...
<script src="${contextPath}/styles/MyDatePicker97/WdatePicker.js" type="text/javascript" charset="utf-8"></script>
<%--
...
$(function(){	
	if($.browser.msie && $.browser.version < 8){ alert('您的浏览器版本太低，请升级浏览器版本 ');};
...
<body scroll="no">
<div id="layout">
	<div id="header" style="background:url('${contextPath}/styles/images/web_logo.jpg') no-repeat;">
		<div class="headerNav" >
...
<div id="footer"><%--Copyright &copy; 2010-2014, jnlmd, All Rights Reserve.--%></div>
</body>
</html>
...
import com.ketayao.ketacustom.shiro.BaseFormAuthenticationFilter;
...
import com.lmd.ggzy.shiro.OtherAutnenticationException;
import com.lmd.ggzy.shiro.WebRoleAuthenticationException;
...
public class LoginController {
	...
	public String fail(
		...
		map.put("msg", msg);
		map.put("username", StringUtils.defaultIfBlank(username, caName));
	...
	private String parseException(ServletRequest request) {
		...
		if (error != null) {
			if (error.equals(UnknownAccountException.class))
				...
				msg = ObjectUtils.toString(request.getAttribute(BaseFormAuthenticationFilter.DEFAULT_ERROR_MESSAGE_KEY_PARAM_NAME)); 
		}

...
public class ModuleController {
	...
	public @ResponseBody String create(@Valid Module module, @RequestParam(value = "showDevice", required = false) int[] showDevice) {
		...
		if(showDevice != null)
			module.setShowDevice(showDevice);
		try {
	...
	public @ResponseBody String update(@Valid Module module, @RequestParam(value = "showDevice", required = false) int[] showDevice) {
...
//		if(showDevice != null)
		...
		oldModule.setShowParent(module.isShowParent());
		oldModule.setJsonParam(module.isJsonParam());
		oldModule.setParameters(module.getParameters());
		oldModule.setBusinessModule(module.isBusinessModule());
		oldModule.setPdaName(module.getPdaName());
